...
public class Main {
    ...
    public Main() { // Ganti konstruktor menjadi sesuai dengan nama kelas (Main)
        dao = new KaryawanDAO();
        loadData();
    ...
    public static void main(String[] args) {
        // Membuat JFrame dan menampilkan form
        JFrame frame = new JFrame("Penerimaan Karyawan");
        frame.setContentPane(new Main().mainPanel); // Menggunakan konstruktor Main
